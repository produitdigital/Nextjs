...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: "Services administratifs et comptables professionnels à distance pour PME et entrepreneurs.",
    ...
    images: [
      {
        url: "/banner.webp", // Utilisation de ta bannière officielle
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    description: "Services comptables professionnels à distance pour PME et entrepreneurs.",
    images: ["/banner.webp"], // Bannière pour Twitter/X
  },
  ...
  return (
    <html lang="fr" suppressHydrationWarning>
      <body className={`${geistSans.variable} ${geistMono.variable}`}>
        ...
        {/* 🔥 GLOBAL BUSINESS SCHEMA (E-E-A-T) */}
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "description": "Services de secrétariat, gestion administrative et pré-comptabilité à distance pour PME.",
